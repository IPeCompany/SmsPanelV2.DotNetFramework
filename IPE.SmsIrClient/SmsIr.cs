...
namespace IPE.SmsIrClient
{
    public class SmsIr
    {
        ...
        {
            return _httpClient.GetRequest<decimal>(CreditRoutes.GetCreditRoute());
        }
        ...
        {
            return _httpClient.GetRequest<long[]>(LineRoutes.GetLinesRoute());
        }
        ...
        {
            return _httpClient.GetRequest<ReceivedMessageResult[]>(ReceiveRoutes.GetLatestReceivesRoute(count));
        }
        ...
        {
            return _httpClient.GetRequest<ReceivedMessageResult[]>(ReceiveRoutes.GetLiveReceivesRoute(pageNumber, pageSize));
        }
        ...
        {
            return _httpClient.GetRequest<ReceivedMessageResult[]>(ReceiveRoutes.GetArchivedReceivesRoute(pageNumber, pageSize, fromDate, toDate));
        }
        ...
        {
            return _httpClient.DeleteRequest<RemoveScheduledMessagesResult>(SendRoutes.RemoveScheduledMessagesRoute(packId));
        }
        ...
        {
            return _httpClient.GetRequest<MessageReportResult>(ReportRoutes.GetSingleMessageReportRoute(messageId));
        }
        ...
        {
            return _httpClient.GetRequest<MessageReportResult[]>(ReportRoutes.GetPackReportRoute(packId));
        }
        ...
        {
            return _httpClient.GetRequest<MessageReportResult[]>(ReportRoutes.GetLiveReportRoute(pageNumber, pageSize));
        }
        ...
        {
            return _httpClient.GetRequest<MessageReportResult[]>(ReportRoutes.GetArchivedReportRoute(pageNumber, pageSize, fromDate, toDate));
        }
        ...
        {
            return _httpClient.GetRequest<PackResult[]>(ReportRoutes.GetSendPacksRoute(pageNumber, pageSize));
        }
    }
}